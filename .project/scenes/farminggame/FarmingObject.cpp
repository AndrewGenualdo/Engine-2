...
void FarmingObject::loadData() {
    ...
    objectData[TypeID::TILE_PLANT_BLUEBERRY] = new TilePlant::PlantData("TILE_PLANT_BLUEBERRY", TypeID::TILE_PLANT_BLUEBERRY, TypeID::TILE_PLANT, TypeID::ITEM_PRODUCE_BLUEBERRY, TypeID::ITEM_SEED_BLUEBERRY, 7, 7, 100, 5, 9);
}
...
void FarmingObject::loadInventory() {
    ...
    world->inventory[TypeID::ITEM_PRODUCE_BLUEBERRY] = FarmingWorld::TILES_HORIZ * FarmingWorld::TILES_VERT;
